...
dataBefore = 'yoochoose-clicks.dat' #Path to Original Training Dataset "Clicks" File
dataTestBefore = 'yoochoose-test.dat' #Path to Original Testing Dataset "Clicks" File
dataAfter = '' #Path to Processed Dataset Folder
